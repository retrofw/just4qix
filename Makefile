...
all: src/main.o src/render.o src/update.o src/input.o src/sound.o src/particle.o
	$(CC) src/main.o src/render.o src/update.o src/input.o src/sound.o src/particle.o -o $(TARGET) -lSDL -lSDL_mixer
...
opk: all
	@mksquashfs \
	just4qix/default.retrofw.desktop \
	just4qix/just4qix.dge \
	just4qix/gfx \
	just4qix/sound \
	just4qix/just4qix.png \
	just4qix/just4qix.opk \
